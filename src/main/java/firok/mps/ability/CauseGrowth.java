...
public class CauseGrowth
{
	...
	public static void BaseAt(World worldIn,BlockPos posSaplingIn,int heightWoodsIn,int heightTreeIn,int radiusLeavesIn,BlockGroup blockWoodIn,BlockGroup blockLeaveIn,boolean ignoreEnvironmentIn,boolean ignoreSubBlocksIn)
	{
	...
	static public boolean canGrow(BlockPos posSaplingIn,int heightWoodsIn,int heightTreeIn,int radiusLeavesIn)
	{
		return true;
	}
