...
public class Mud extends Fluid
{
	...
	public static final ResourceLocation still = new ResourceLocation(TIC.MODID + ":" + "fluid/mud_still");
    public static final ResourceLocation flowing = new ResourceLocation(TIC.MODID + ":" + "fluid/mud_flow");
