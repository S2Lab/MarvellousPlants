...
{
	public static final ResourceLocation still = new ResourceLocation(TIC.MODID + ":" + "fluid/water_of_vitality_still");
    public static final ResourceLocation flowing = new ResourceLocation(TIC.MODID + ":" + "fluid/water_of_vitality_flow");
